...
WHOLECOCO_JOINTS =['nose', 'left_eye', 'right_eye', 'left_ear', 'right_ear', 'left_shoulder', 'right_shoulder', 'left_elbow', 'right_elbow',
                    'left_wrist', 'right_wrist', 'left_hip', 'right_hip', 'left_knee', 'right_knee', 'left_ankle', 'right_ankle', 'pelvis', 
    'left_wrist',
    'left_thumb1', 'left_thumb2', 'left_thumb3', 'left_thumb',
    'left_index1', 'left_index2', 'left_index3', 'left_index',
    'left_middle1', 'left_middle2', 'left_middle3', 'left_middle',
...
def body_model_to_dset(model_type='smplx', dset='coco', joints_to_ign=None,
    ...
    if dset == 'coco':
        ...
        dset_keyp_names = WHOLECOCO_JOINTS
...
def dset_to_hand_model(dset='freihand', joints_to_ign=None):
    if joints_to_ign is None:
        joints_to_ign = []
    mapping = {}
    if dset=='interh26m':
        dset_keyp_names = INTERH26M
    else:
        raise ValueError('Unknown dset dataset: {}'.format(dset))
    for idx, name in enumerate(FREIHAND_NAMES):
...
def dset_to_body_model(model_type='smplx', dset='coco', joints_to_ign=None,
    ...
    if dset == 'coco':
        ...
        dset_keyp_names = VIBE_SPIN_KEYPOINT_NAMES
    else:
        raise ValueError('Unknown dset dataset: {}'.format(dset))
